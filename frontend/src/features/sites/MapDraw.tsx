...
const MAPBOX_TOKEN = import.meta.env.VITE_MAPBOX_TOKEN || 'pk.eyJ1IjoiZGFydWthYS1lYXJ0aCIsImEiOiJjbHAxMjM0NTYifQ.placeholder';

mapboxgl.accessToken = MAPBOX_TOKEN;

interface MapDrawProps {
  onPolygonDrawn: (geojson: GeoJSON.Polygon, areaM2: number) => void;
...
export const MapDraw: React.FC<MapDrawProps> = ({
  onPolygonDrawn,
  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: '420px', borderRadius: 'var(--radius-lg)', overflow: 'hidden', border: '1px solid var(--color-border)' }}>
