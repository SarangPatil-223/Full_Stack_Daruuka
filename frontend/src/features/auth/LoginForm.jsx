    ...
    >
      <div>
        ...
        <p style={{ opacity: 0.8, lineHeight: 1.65, fontSize: '0.95rem' }}>
          Track carbon sequestration and biodiversity impact across your environmental restoration
          projects with precision geospatial analytics.
        </p>
      </div>
...
export const LoginForm = () => {
  ...
  return (
    <AuthLayout>
      ...
      >
        Sign in to your Darukaa account
      </p>
